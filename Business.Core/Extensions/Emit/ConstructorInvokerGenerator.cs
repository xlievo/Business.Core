...
namespace Business.Extensions.Emit
{
    public static class ConstructorInvokerGenerator
    {
        ...
        public static System.Func<object> CreateDelegate(System.Type type)
        {
            ...
            var dynamicMethod = EmitUtils.CreateDynamicMethod(string.Format("{0}_{1}", "$Create", type), typeof(object), System.Type.EmptyTypes, type);
            var il = dynamicMethod.GetILGenerator();
            ...
            il.Ret();
            return (System.Func<object>)dynamicMethod.CreateDelegate(typeof(System.Func<object>));
        }
