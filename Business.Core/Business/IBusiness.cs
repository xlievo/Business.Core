...
namespace Business.Core
{
        ...
        where Arg : IArg, new()
    {
        ...
        /// Get token
        /// </summary>
        public System.Func<dynamic, Auth.IToken, System.Threading.Tasks.Task<Auth.IToken>> GetToken { get; set; } = async (c, token) => token;
...
//    public interface IBusiness<Result, Arg, Token> : IBusiness where Result : Core.Result.IResult where Arg : IArg, new() where Token : Auth.IToken, new() { }

//    //public interface IBusiness<Result, Arg> : IBusiness where Result : Core.Result.IResult where Arg : IArg, new() { }
//    public interface IBusiness<Result, Arg> : IBusiness<Result, Arg, Auth.Token> where Result : Core.Result.IResult where Arg : IArg, new() { }

//    public interface IBusiness<Result> : IBusiness<Result, Arg<object>> where Result : Core.Result.IResult { }

//    public abstract partial class BusinessBase<Result, Arg, Token> : IBusiness<Result, Arg, Token>
//        where Result : Core.Result.IResult
//        where Arg : IArg, new()
...
//    public abstract class BusinessBase<Result, Arg> : BusinessBase<Result, Arg, Auth.Token>, IBusiness<Result, Arg> where Result : Core.Result.IResult where Arg : IArg, new() { }

//    public abstract class BusinessBase<Result> : BusinessBase<Result, Arg<object>, Auth.Token>, IBusiness<Result> where Result : Core.Result.IResult { }

//    //public abstract class BusinessBase<Result> : BusinessBase<Result, Arg<object>>, IBusiness<Result> where Result : Core.Result.IResult { }

//    public abstract class BusinessBase : BusinessBase<Result.ResultObject<object>>, IBusiness { }
//}
