...
public partial class BusinessMember2 : BusinessBase
{
    ...
    [Testing("test, important logic, do not delete!!!",
        ...
        tokenMethod: login)]
    public virtual async Task<IResult<Test001Result?>> Test001(Token token, Test001 arg, DateTime? dateTime, HttpFile httpFile = null, [Ignore(IgnoreMode.BusinessArg)][Test2]decimal mm = 0.0234m, [Ignore(IgnoreMode.BusinessArg)]int fff = 666, [Ignore(IgnoreMode.BusinessArg)]bool bbb = true)
    {
